...
module.exports.createReport = async (req,res,next) => {
   ...
   const trip = await Trip.findByIdAndUpdate(id, {isActive: false, end_date: endDate, end_station: "" });
   const bike = await Bike.findByIdAndUpdate(trip.bike, {isRented: false, $unset: {station: 1}});
   if(!bike){
    res.json({
